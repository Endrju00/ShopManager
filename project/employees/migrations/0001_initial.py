    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(db_column='nazwa', help_text='Please pass the name of the position.', max_length=100, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('position', models.ForeignKey(db_column='nazwa_stanowiska', help_text='Please choose the position for the employee', null=True, on_delete=django.db.models.deletion.RESTRICT, to='employees.position')),
            ],
            options={
                'db_table': 'Pracownicy',
