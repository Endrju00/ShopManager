    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(db_column='id_kategorii', help_text='Please select the category of the product.', null=True, on_delete=django.db.models.deletion.SET_NULL, to='products.category')),
                ('producer', models.ForeignKey(db_column='id_producenta', help_text='Please select the producer of the producer.', null=True, on_delete=django.db.models.deletion.SET_NULL, to='products.producer')),
            ],
            options={
                'db_table': 'Produkty',
                'ordering': ['name'],
